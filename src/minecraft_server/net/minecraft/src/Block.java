...
public class Block
{
    ...
    public static Block cloth = new FCBlockCloth();
    ...
    public static BlockChest chest = (BlockChest)(new FCBlockChest(54)).setCreativeTab((CreativeTabs)null);
    ...
    public static Block oreRedstoneGlowing = (new FCBlockRedstoneOre(74, true)).setLightValue(0.625F).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreRedstone").setCreativeTab((CreativeTabs)null);
    ...
    public static Block netherFence = (new FCBlockFence(113, "netherBrick", FCBetterThanWolves.fcMaterialNetherRock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("netherFence");
    ...
    static
    {
        ...
        m_iRotatedFacingsAroundJClockwise = new int[] {0, 1, 4, 5, 3, 2};
