...
public class AutoPlusBlockChute extends BlockContainer implements FCIBlockMechanical
{
        ...
        if (var5.boundingBox.intersectsWith(var7) && !var5.isDead)
        {
            ...
            if (var10.CanCurrentFilterProcessItem(var9))
            {
                ...
                if (var11 != null && var11.CanTransformItemIfFilter(var9))
                {
                    ...
                    else if (var12 == FCBetterThanWolves.fcItemWheat.itemID)
                    {
                        ItemStack stackOne = new ItemStack(FCBetterThanWolves.fcItemWheatSeeds.itemID, var9.stackSize, 0);
                        ItemStack stackTwo = new ItemStack(FCBetterThanWolves.fcItemWheatSeeds.itemID, var9.stackSize, 0);
                        boolean var14 = false;
                        int var17;

                        if (FCUtilsInventory.AddItemStackToInventoryInSlotRange(var10, stackOne, 0, 17) && FCUtilsInventory.AddItemStackToInventoryInSlotRange(var10, stackTwo, 0, 17))
                        {
                            var17 = var9.stackSize;
                            var5.setDead();
                        }
                        ...
                        {
                            var17 = var5.getEntityItem().stackSize - stackOne.stackSize;
                            ItemStack var10000 = var5.getEntityItem();
                            var10000.stackSize -= var17;
                        }
                        ...
                        {
                            var1.playAuxSFX(2231, var2, var3, var4, 0);
                            ItemStack var15 = new ItemStack(FCBetterThanWolves.fcItemStraw.itemID, var17, 0);
                            EntityItem var16 = new EntityItem(var1, var5.posX, var5.posY, var5.posZ, var15);
                            var16.delayBeforeCanPickup = 10;
                            var1.spawnEntityInWorld(var16);
                        }
    ...
    {
        this.m_IconBinBySideArray[0] = var1.registerIcon("fcBlockHopperBin_bottom");
        this.m_IconBinBySideArray[1] = var1.registerIcon("fcBlockHopperBin_top");
        Icon var2 = var1.registerIcon("fcBlockHopperBin_side");
        this.m_IconBinBySideArray[2] = var2;
        this.m_IconBinBySideArray[3] = var2;
        this.m_IconBinBySideArray[4] = var2;
        this.m_IconBinBySideArray[5] = var2;
        this.blockIcon = var2;
        this.m_IconNozzleBySideArray[0] = var1.registerIcon("fcBlockHopperNozzle_bottom");
        this.m_IconNozzleBySideArray[1] = this.m_IconBinBySideArray[1];
        var2 = var1.registerIcon("fcBlockHopperNozzle_side");
        this.m_IconNozzleBySideArray[2] = var2;
        this.m_IconNozzleBySideArray[3] = var2;
        this.m_IconNozzleBySideArray[4] = var2;
        this.m_IconNozzleBySideArray[5] = var2;
        this.m_IconInteriorSide = var1.registerIcon("fcBlockHopperInterior_side");
        this.m_IconInteriorTop = var1.registerIcon("fcBlockHopperInterior_top");
        this.m_IconContents = var1.registerIcon("fcBlockHopper_contents");
    }
    ...
    {
        return this.m_bIsRenderingNozzle ? this.m_IconNozzleBySideArray[var1] : this.m_IconBinBySideArray[var1];
    }
    ...
    {
        return AxisAlignedBB.getAABBPool().getAABB(0.0D, 0.25D, 0.0D, 1.0D, 1.0D, 1.0D).offset((double)var2, (double)var3, (double)var4);
    }
    ...
    public boolean RenderBlock(RenderBlocks var1, int var2, int var3, int var4)
    {
        ...
        this.m_bIsRenderingNozzle = false;
        ...
        float var7 = 0.66F;
        int var8 = this.colorMultiplier(var5, var2, var3, var4);
        float var9 = (float)(var8 >> 16 & 255) / 255.0F;
        float var10 = (float)(var8 >> 8 & 255) / 255.0F;
        float var11 = (float)(var8 & 255) / 255.0F;
        var6.setColorOpaque_F(0.66F * var9, 0.66F * var10, 0.66F * var11);
        double var12 = 0.124D;
        var1.renderFaceXPos(this, (double)var2 - 1.0D + 0.124D, (double)var3, (double)var4, this.m_IconInteriorSide);
        var1.renderFaceXNeg(this, (double)var2 + 1.0D - 0.124D, (double)var3, (double)var4, this.m_IconInteriorSide);
        var1.renderFaceZPos(this, (double)var2, (double)var3, (double)var4 - 1.0D + 0.124D, this.m_IconInteriorSide);
        var1.renderFaceZNeg(this, (double)var2, (double)var3, (double)var4 + 1.0D - 0.124D, this.m_IconInteriorSide);
        var1.renderFaceYPos(this, (double)var2, (double)var3 - 1.0D + 0.25D, (double)var4, this.m_IconInteriorTop);
        this.m_bIsRenderingNozzle = true;
        var1.setRenderBounds(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.25D, 0.6875D);
        var1.renderStandardBlock(this, var2, var3, var4);
        FCTileEntityHopper var14 = (FCTileEntityHopper)var5.getBlockTileEntity(var2, var3, var4);
        short var15 = var14.m_sStorageSlotsOccupied;

        if (var15 > 0)
        {
            float var16 = (float)var15 / 18.0F;
            float var17 = 0.375F;
            float var18 = var17 + 0.0625F + (0.875F - (var17 + 0.0625F)) * var16;
            var1.setRenderBounds(0.125D, (double)var17, 0.125D, 0.875D, (double)var18, 0.875D);
            FCClientUtilsRender.RenderStandardBlockWithTexture(var1, this, var2, var3, var4, this.m_IconContents);
        }

        Item var19 = var14.GetCurrentFilterItem();

        if (var19 != null)
        {
            Icon var20 = var19.GetHopperFilterIcon();

            if (var20 != null)
            {
                var1.setRenderBounds(0.125D, 0.875D, 0.125D, 0.875D, 0.9375D, 0.875D);
                FCClientUtilsRender.RenderStandardBlockWithTexture(var1, this, var2, var3, var4, var20);
            }
        }
    ...
    {
        IBlockAccess var4 = var1.blockAccess;
        this.m_bIsRenderingNozzle = false;
        var1.setRenderBounds(0.0D, 0.25D, 0.0D, 1.0D, 1.0D, 1.0D);
        ...
        var1.renderFaceYPos(this, 0.0D, -0.75D, 0.0D, this.m_IconInteriorTop);
        var5.draw();
        var5.startDrawingQuads();
        var5.setNormal(0.0F, 0.0F, -1.0F);
        var1.renderFaceZNeg(this, 0.0D, 0.0D, 0.876D, this.m_IconInteriorSide);
        var5.draw();
        var5.startDrawingQuads();
        var5.setNormal(0.0F, 0.0F, 1.0F);
        var1.renderFaceZPos(this, 0.0D, 0.0D, -0.876D, this.m_IconInteriorSide);
        var5.draw();
        var5.startDrawingQuads();
        var5.setNormal(-1.0F, 0.0F, 0.0F);
        var1.renderFaceXNeg(this, 0.876D, 0.0D, 0.0D, this.m_IconInteriorSide);
        var5.draw();
        var5.startDrawingQuads();
        var5.setNormal(1.0F, 0.0F, 0.0F);
        var1.renderFaceXPos(this, -0.876D, 0.0D, 0.0D, this.m_IconInteriorSide);
        var5.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
        this.m_bIsRenderingNozzle = true;
        var1.setRenderBounds(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.25D, 0.6875D);
